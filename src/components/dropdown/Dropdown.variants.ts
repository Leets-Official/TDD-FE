...
export const dropdownVariants = tv({
  slots: {
    ...
    option:
      "flex cursor-pointer items-center gap-xxs text-text-1 transition-colors hover:bg-hover focus:bg-hover focus:outline-none data-[disabled=true]:cursor-not-allowed data-[disabled=true]:text-disabled data-[selected=true]:bg-pressed",
  },
  variants: {
    variant: {
      select: {
        root: "w-full",
        trigger: "gap-xxs rounded-md px-padding-l py-l text-body-1",
