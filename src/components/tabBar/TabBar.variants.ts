...
export const tabBarVariants = tv({
  slots: {
    ...
    label:
      "relative inline-block after:absolute after:-inset-x-[5px] after:-bottom-padding-s after:hidden after:h-0.5 after:bg-text-1 group-data-[selected=true]:after:block",
  },
});
